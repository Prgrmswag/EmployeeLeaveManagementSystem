...
$leaveType = $r[0]->LeaveType;

echo "<script>console.log('Debug Objects: " . $leaveType . "' );</script>";

$sql2 = "delete from tblleaves WHERE tblleaves.LeaveType='$leaveType'";
$query = $dbh->prepare($sql2);
$query -> execute();

$leaveType = str_replace(' ','',$leaveType);

$sql2 = "alter table totalleaves drop column $leaveType";
$query = $dbh->prepare($sql2);
$query -> execute();
...
{               ?>  
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->TotalLeaves);?></td>
